...
DC_BEGIN_NAMESPACE
/********************************************************************/
IMPL_DERIVED_REFECTION_TYPE(DX12ShaderReflect, Object);
void DX12ShaderReflect::Reflect(ShaderType type, ID3DBlob* shader_code)
{
	//反射shader信息
...
int DX12ShaderReflect::Reflect(const String& path, const ShaderDesc& shaderInfo, const char* version)
{
