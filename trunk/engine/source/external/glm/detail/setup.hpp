...
#if GLM_PLATFORM == GLM_DC_PLATFORM_ANDROID && !defined(GLM_LANG_STL11_FORCED)
...
//#	elif(GLM_PLATFORM & GLM_DC_PLATFORM_IOS)
...
#	elif(GLM_PLATFORM & GLM_DC_PLATFORM_ANDROID)
#		pragma message("GLM: Android platform detected")
#	elif(GLM_PLATFORM & GLM_DC_PLATFORM_LINUX)
