...
#				else
					return ::isnan(x) != 0;
#				endif
#			elif (GLM_COMPILER & (GLM_COMPILER_GCC | GLM_COMPILER_CLANG)) && (GLM_PLATFORM & GLM_DC_PLATFORM_ANDROID) && __cplusplus < 201103L
				return _isnan(x) != 0;
...
#				if(GLM_PLATFORM & GLM_DC_PLATFORM_ANDROID && __cplusplus < 201103L)
					return _isinf(x) != 0;
#				else
					return std::isinf(x);
#				endif
