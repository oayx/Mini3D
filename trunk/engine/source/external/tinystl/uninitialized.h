...
inline ForwardIterator __uninitialized_copy_aux(InputIterator first, InputIterator last,
    ...
    return tinystl::copy(first, last, result);  // 如果是 __true_type，调用高层函数 copy
}
...
inline void __uninitialized_fill_aux(ForwardIterator first, ForwardIterator last, const T& x, __true_type) {
    tinystl::fill(first, last, x);  // 如果是 __true_type，调用高层函数 fill
}
...
inline ForwardIterator __uninitialized_fill_n_aux(ForwardIterator first, Size n, const T& x, __true_type) {
    return tinystl::fill_n(first, n, x);  // 如果是 __true_type，调用高层函数 fill_n
}
