    ...
    namespace test {
        namespace list_test {
            ...
            void list_test() {
                ...
                tinystl::list<int> l7 = l3;
                tinystl::list<int> l8 = std::move(l3);
                l8.~list();
                ...
                LIST_INSERT_TEST(tinystl, LEN1);
                LIST_INSERT_TEST(tinystl, LEN2);
                LIST_INSERT_TEST(tinystl, LEN3);
                std::cout << std::endl;
                std::cout << "|---------------------|-------------|-------------|-------------|" << std::endl;
                std::cout << "|         sort        |";
                TEST_LEN(LEN1, LEN2, LEN3, WIDE);
                ...
                std::cout << std::endl << "|        tinystl        |";
                LIST_SORT_TEST(tinystl, LEN1);
                LIST_SORT_TEST(tinystl, LEN2);
                LIST_SORT_TEST(tinystl, LEN3);
                std::cout << std::endl;
                std::cout << "|---------------------|-------------|-------------|-------------|" << std::endl;
                PASSED;
