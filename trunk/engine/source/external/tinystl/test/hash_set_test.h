    ...
    namespace test {
        namespace hash_set_test {
            ...
            void hash_set_test() {
                ...
                int a[] = { 5,4,3,2,1 };
                tinystl::hash_set<int> hs1;
                tinystl::hash_set<int> hs2(520);
                tinystl::hash_set<int> hs3(520, tinystl::hash<int>());
                tinystl::hash_set<int> hs4(520, tinystl::hash<int>(), tinystl::equal_to<int>());
                tinystl::hash_set<int> hs5(a, a + 5);
                tinystl::hash_set<int> hs6(a, a + 5, 520);
                tinystl::hash_set<int> hs7(a, a + 5, 520, tinystl::hash<int>());
                tinystl::hash_set<int> hs8(a, a + 5, 520, tinystl::hash<int>(), tinystl::equal_to<int>());
                tinystl::hash_set<int> hs9(hs2);
                tinystl::hash_set<int> hs10(std::move(hs2));
                tinystl::hash_set<int> hs11 = hs3;
                tinystl::hash_set<int> hs12 = std::move(hs3);
                ...
                SET_INSERT_TEST(tinystl, hash_set, LEN1);
                SET_INSERT_TEST(tinystl, hash_set, LEN2);
                SET_INSERT_TEST(tinystl, hash_set, LEN3);
                std::cout << std::endl;
                std::cout << "|---------------------|-------------|-------------|-------------|" << std::endl;
                PASSED;
            ...
            void hash_multiset_test() {
                ...
                std::cout << "[-------------------------- API test ---------------------------]" << std::endl;
                int a[] = { 5,4,3,2,1 };
                tinystl::hash_multiset<int> hs1;
                tinystl::hash_multiset<int> hs2(520);
                tinystl::hash_multiset<int> hs3(520, tinystl::hash<int>());
                tinystl::hash_multiset<int> hs4(520, tinystl::hash<int>(), tinystl::equal_to<int>());
                tinystl::hash_multiset<int> hs5(a, a + 5);
                tinystl::hash_multiset<int> hs6(a, a + 5, 520);
                tinystl::hash_multiset<int> hs7(a, a + 5, 520, tinystl::hash<int>());
                tinystl::hash_multiset<int> hs8(a, a + 5, 520, tinystl::hash<int>(), tinystl::equal_to<int>());
                tinystl::hash_multiset<int> hs9(hs2);
                tinystl::hash_multiset<int> hs10(std::move(hs2));
                tinystl::hash_multiset<int> hs11 = hs3;
                tinystl::hash_multiset<int> hs12 = std::move(hs3);
                ...
                std::cout << std::endl << "|        tinystl        |";
                SET_INSERT_TEST(tinystl, hash_multiset, LEN1);
                SET_INSERT_TEST(tinystl, hash_multiset, LEN2);
                SET_INSERT_TEST(tinystl, hash_multiset, LEN3);
                std::cout << std::endl;
                std::cout << "|---------------------|-------------|-------------|-------------|" << std::endl;
                PASSED;
