    ...
    namespace test {
        namespace vector_test {
            ...
            void vector_test() {
                ...
                tinystl::vector<int> v7 = v3;
                tinystl::vector<int> v8 = std::move(v3);
                v8.~vector();
                ...
                *++p = 20;
                ...
                VECTOR_PUSH_BACK_TEST(tinystl, LEN2);
                VECTOR_PUSH_BACK_TEST(tinystl, LEN3);
                VECTOR_PUSH_BACK_TEST(tinystl, LEN4);
                std::cout << std::endl;
                std::cout << "|---------------------|-------------|-------------|-------------|" << std::endl;
                PASSED;
