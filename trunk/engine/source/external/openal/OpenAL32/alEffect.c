...
static void null_SetParami2(ALeffect *effect, ALCcontext *context, ALenum param, ALint val)
{ (void)effect;(void)param;(void)val; alSetError(context, AL_INVALID_ENUM); }
static void null_SetParamiv2(ALeffect *effect, ALCcontext *context, ALenum param, const ALint *vals)
{ (void)effect;(void)param;(void)vals; alSetError(context, AL_INVALID_ENUM); }
static void null_SetParamf2(ALeffect *effect, ALCcontext *context, ALenum param, ALfloat val)
{ (void)effect;(void)param;(void)val; alSetError(context, AL_INVALID_ENUM); }
static void null_SetParamfv2(ALeffect *effect, ALCcontext *context, ALenum param, const ALfloat *vals)
{ (void)effect;(void)param;(void)vals; alSetError(context, AL_INVALID_ENUM); }

static void null_GetParami2(ALeffect *effect, ALCcontext *context, ALenum param, ALint *val)
{ (void)effect;(void)param;(void)val; alSetError(context, AL_INVALID_ENUM); }
static void null_GetParamiv2(ALeffect *effect, ALCcontext *context, ALenum param, ALint *vals)
{ (void)effect;(void)param;(void)vals; alSetError(context, AL_INVALID_ENUM); }
static void null_GetParamf2(ALeffect *effect, ALCcontext *context, ALenum param, ALfloat *val)
{ (void)effect;(void)param;(void)val; alSetError(context, AL_INVALID_ENUM); }
static void null_GetParamfv2(ALeffect *effect, ALCcontext *context, ALenum param, ALfloat *vals)
{ (void)effect;(void)param;(void)vals; alSetError(context, AL_INVALID_ENUM); }
...
static void InitEffectParams(ALeffect *effect, ALenum type)
{
    ...
    case AL_EFFECT_DEDICATED_DIALOGUE:
        ...
        break;
    default:
        effect->SetParami  = null_SetParami2;
        effect->SetParamiv = null_SetParamiv2;
        effect->SetParamf  = null_SetParamf2;
        effect->SetParamfv = null_SetParamfv2;
        effect->GetParami  = null_GetParami2;
        effect->GetParamiv = null_GetParamiv2;
        effect->GetParamf  = null_GetParamf2;
        effect->GetParamfv = null_GetParamfv2;
        break;
    }
    effect->type = type;
}
