...
layout(location = 6) out float var_TEXCOORD6;
...
void main()
{
    ...
    var_TEXCOORD1 = mat3(_73, cross(_71, _73) * in_var_TANGENT.w, _71);
    var_TEXCOORD4 = normalize(CameraBuffer._WorldSpaceCameraPos - _81);
    var_TEXCOORD5 = _101;
    var_TEXCOORD6 = _64.z;
}
