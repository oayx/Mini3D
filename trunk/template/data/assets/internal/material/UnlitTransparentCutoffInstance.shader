<Shader Group="Unlit/Instance/Transparent Cutoff">
    ...
    <Pass>
        ...
        <CG File="UnlitTransparentCutoffInstance.hlsl">
            <VS/>
            <PS/>
            <Reflect>
                <Semantics Value="531"/>
                <CBuffers>
                    ...
                    <CBuffer Name="CustomBuffer" Slot="0" Size="112" Stage="4">
                        <Variables>
                            <Variable Name="LIGHT_MATRIX_MVP" Offset="0" Size="64" Stage="4"/>
                            <Variable Name="_Color" Offset="80" Size="16" Stage="4"/>
                            <Variable Name="_Cutoff" Offset="96" Size="4" Stage="4"/>
