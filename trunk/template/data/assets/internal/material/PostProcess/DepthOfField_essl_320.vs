...
layout(location = 3) out vec4 out_var_TEXCOORD3;
...
void main()
{
    ...
    out_var_TEXCOORD1 = in_var_TEXCOORD0.xyxy + _46;
    out_var_TEXCOORD2 = in_var_TEXCOORD0.xyxy + (_46 * 2.0);
    out_var_TEXCOORD3 = in_var_TEXCOORD0.xyxy + (_46 * 3.0);
}
