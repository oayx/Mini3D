<Shader>
    ...
    <Properties>
        <Propertie Name="_SpecularPower" Alias="SpecularPower" Type="Float" Value="0.1" Range="0,1"/>
        <Propertie Name="_Reflections" Alias="Reflections" Type="Float" Value="0.0" Range="0,1"/>
    </Properties>
    <TextureUnits>
        <TextureUnit Name="_MainTex"/>
        <TextureUnit Name="_NormalTexture"/>
    </TextureUnits>
    <Pass>
        <CG File="Standard.hlsl">
            <VS/>
            <PS/>
            <Reflect>
                <Semantics Value="29"/>
                <CBuffers>
                    ...
                    <CBuffer Name="CustomBuffer" Slot="0" Size="32" Stage="4">
                        <Variables>
                            ...
                            <Variable Name="_Reflections" Offset="20" Size="4" Stage="4"/>
                ...
                <Textures>
                    ...
                    <Texture Name="_SkyBox" Type="3" Slot="2" Stage="4"/>
                </Textures>
            </Reflect>
        </CG>
    </Pass>
