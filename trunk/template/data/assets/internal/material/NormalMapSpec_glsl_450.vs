...
void main()
{
    ...
    out_var_TEXCOORD1 = mat3(_73, cross(_71, _73) * in_var_TANGENT.w, _71);
    out_var_TEXCOORD4 = normalize(CameraBuffer._WorldSpaceCameraPos - _81);
    out_var_TEXCOORD5 = _101;
    out_var_TEXCOORD6 = _64.z;
}
