...
varying mat3 varying_TEXCOORD4;
varying vec3 varying_TEXCOORD7;
varying vec3 varying_TEXCOORD8;
varying float varying_TEXCOORD9;
...
void main()
{
    ...
    vec3 _113;
    for (int SPIRV_Cross_Dummy303 = 0; SPIRV_Cross_Dummy303 < 1; SPIRV_Cross_Dummy303++)
    {
    ...
    varying_TEXCOORD2 = (in_var_TEXCOORD0 * CustomBuffer._MainTex2_ST.xy) + CustomBuffer._MainTex2_ST.zw;
    varying_TEXCOORD3 = in_var_TEXCOORD0;
    varying_TEXCOORD4 = mat3(_89, cross(_87, _89) * in_var_TANGENT.w, _87);
    varying_TEXCOORD7 = _113;
    varying_TEXCOORD8 = normalize(CameraBuffer._WorldSpaceCameraPos - _97);
    varying_TEXCOORD9 = _68.z;
}
