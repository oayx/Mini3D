...
{ 
	...
	float halfWidth = 0.5f * input[0].size;
	float halfHeight = 0.5f * input[0].size;
	v[0] = center + float4(-halfWidth, -halfHeight, 0.0f, 0.0f);
	v[1] = center + float4(-halfWidth, halfHeight, 0.0f, 0.0f);
	v[2] = center + float4(halfWidth, -halfHeight, 0.0f, 0.0f);
	v[3] = center + float4(halfWidth, halfHeight, 0.0f, 0.0f);
